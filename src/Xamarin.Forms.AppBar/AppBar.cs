...
namespace Xamarin.Forms.AppBar
{
    public class AppBar : ContentView
    {
        ...
        Popup _righItemsPopup;
        StackLayout _popupContainer;
        Label _titleLabel;
        BoxView _barBorder;
        ...
        void Initialize()
        {
            ...
            _popupContainer = new StackLayout
            {
                BackgroundColor = Color.Black,
                WidthRequest = 200
            };

            _righItemsPopup = new Popup
            {
                HorizontalOptions = LayoutOptions.EndAndExpand,
                VerticalOptions = LayoutOptions.StartAndExpand,
                Anchor = _rightItemsIcon,
                View = _popupContainer
            };
        ...
        void ClearSecondaryToolBarItems()
        {
            ...
            _popupContainer.Children.Clear();
        }
        ...
        void AddSecondaryToolBarItem(ToolbarItem item)
        {
            ...
            _popupContainer.Children.Add(secondaryToolBarItem);
        ...
        void OnRightItemsTapped(object sender, EventArgs e)
        {
            ...
            DependencyService.Get<IPopupService>().ShowPopup(_righItemsPopup);
        }
    }
}